...
# -*- coding: utf-8 -*-
#
# PoreAna documentation build configuration file, created by
...
html_theme_options = {
    ...
    'bootstrap_version': "3",
    'navbar_links': [("API", "api"), ("Sample", "sample"), ("Density", "density"), ("Diffusion (Bin)", "diffusion_bin"), ("Diffusion (MC)", "diffusion_mc"), ("Diffusion (VACF)", "diffusion_vacf"), ("Further Properties", "further_props"),],
}
